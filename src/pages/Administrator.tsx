    ...
    <section className="admin-page">
      <header className="admin-hero">
        <div>
          ...
          <h1>Administrator</h1>
          <p>Zentrale Anlage für neue Immobilien, Mieterstammdaten und Benutzerrechte.</p>
        </div>
      </header>
          ...
          <div className="admin-panel">
            <div className="admin-panel-head">
              ...
              <div>
                ...
                <p>Mieterstammdaten und Mietverhältnisse zentral pflegen.</p>
              </div>
            </div>
            <Link className="admin-link-button" to="/mieter-anlegen">Mieter anlegen öffnen</Link>
          </div>
